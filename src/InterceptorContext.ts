...
export class InterceptorContext<T> {
    ...
    get behavior(): all.MockBehavior {
        return this.mock.behavior; 
    } 

    addInvocation(invocation: all.ICallContext) {
    ...
    addExpectedCall(call: all.IProxyCall<T>) {
